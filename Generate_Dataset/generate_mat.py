...
Generate the Matrix Projection dataset with the opposed direction field.
...
MAX_ANGLE = 40.0
# RESULTS_FOLDER = '/mnt/researchers/cristian-tejos/datasets/STI_dataset/Matrix_Projection2/'
RESULTS_FOLDER = '../../Dataset/Matrix_Projection/'
# RESULTS_FOLDER = '../../Imagenes/Dataset/Matrix_Projection2/'
