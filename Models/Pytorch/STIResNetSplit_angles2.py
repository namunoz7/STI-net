...
class STIResNetSplit(nn.Module):
    class BottleneckAttention(nn.Module):
        ...
        def forward(self, x, parameter_angles):
            ...
            x1 = torch.cat((self.avg_pool(x).view(n_batch, n_channels), parameter_angles), dim=1)
    ...
    def __init__(self, in_channels=6, out_channels=(3, 3), init_features=32, stride=(2, 2, 2)):
        ...
        self.bottleneck1 = STIResNetSplit._bottleneck(8 * features, 16 * features, name="bottleneck", stride=(2, 2, 2))
        self.bottleneck_attention = self.BottleneckAttention(16 * features)
        self.bottleneck2 = STIResNetSplit._bottleneck(16 * features, 8 * features, name="bottleneck", stride=(1, 1, 1))
    ...
    def forward(self, x, parameter_angles):
        ...
        bottleneck1 = self.bottleneck1(enc3)
        ...
        dec3_i = self.up_conv3_i(bottleneck)
        ...
        dec3_a = self.up_conv3_a(bottleneck)
