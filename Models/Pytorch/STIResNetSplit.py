...
class STIResNetSplit(nn.Module):
    def __init__(self, in_channels=6, out_channels=(3, 3), init_features=32, stride=(2, 2, 2)):
        ...
        # Isotropic decoder
        # ------------------------------------
        self.up_conv4_i = nn.ConvTranspose3d(32 * features, 16 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder4_i = STIResNetSplit._dec_block(2 * (16 * features), 16 * features, name="dec4_i")
        self.up_conv3_i = nn.ConvTranspose3d(16 * features, 8 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder3_i = STIResNetSplit._dec_block(2 * (8 * features), 8 * features, name="dec3_i")
        self.up_conv2_i = nn.ConvTranspose3d(8 * features, 4 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder2_i = STIResNetSplit._dec_block(2 * (4 * features), 4 * features, name="dec2_i")
        self.up_conv1_i = nn.ConvTranspose3d(4 * features, 2 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder1_i = STIResNetSplit._dec_block(2 * (2 * features), 2 * features, name="dec1_i")

        self.up_conv0_i = nn.ConvTranspose3d(2 * features, features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        ...
        # Anisotropic decoder
        # ------------------------------------
        self.up_conv4_a = nn.ConvTranspose3d(32 * features, 16 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder4_a = STIResNetSplit._dec_block(2 * (16 * features), 16 * features, name="dec4_a")
        self.up_conv3_a = nn.ConvTranspose3d(16 * features, 8 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder3_a = STIResNetSplit._dec_block(2 * (8 * features), 8 * features, name="dec3_a")
        self.up_conv2_a = nn.ConvTranspose3d(8 * features, 4 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder2_a = STIResNetSplit._dec_block(2 * (4 * features), 4 * features, name="dec2_a")
        self.up_conv1_a = nn.ConvTranspose3d(4 * features, 2 * features, kernel_size=(2, 2, 2),
                                             stride=(2, 2, 2), device=DEVICE)
        self.decoder1_a = STIResNetSplit._dec_block(2 * (2 * features), 2 * features, name="dec1_a")

        self.up_conv0_a = nn.ConvTranspose3d(2 * features, features, kernel_size=(2, 2, 2), stride=(2, 2, 2),
                                             device=DEVICE)
